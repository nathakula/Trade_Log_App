...
export const YTDView: React.FC<YTDViewProps> = ({ monthlyData, entries }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">YTD Realized P&L</p>
      ...
      {/* Monthly Chart */}
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold text-gray-900 mb-6 text-center">Monthly Trading P&L vs End-of-Month NAV</h3>
        ...
        {monthlyData.length === 0 ? (
          ...
          <div className="relative bg-gray-800 rounded-xl p-6">
              ...
              <svg className="absolute inset-0 w-full h-80" style={{ zIndex: 1 }}>
                <defs>
                  <pattern id="grid" width="40" height="32" patternUnits="userSpaceOnUse">
                    <path d="M 40 0 L 0 0 0 32" fill="none" stroke="#4a5568" strokeWidth="0.5" opacity="0.3"/>
                  </pattern>
                </defs>
            ...
            {/* X-axis labels */}
            <div className="flex justify-between text-xs text-gray-400 px-12 mb-4">
              {monthlyData.map((month, index) => (
            ...
            <div className="flex justify-between items-center text-xs text-gray-400 mb-4">
              <div className="flex flex-col space-y-1">
                <span className="font-medium text-gray-300">MONTHLY P&L ($)</span>
              ...
              <div className="flex flex-col items-end space-y-1">
                <span className="font-medium text-gray-300">EOD NAV ($)</span>
                <div className="flex items-center space-x-2">
                  <span>NAV Trend</span>
            ...
            <div className="absolute bottom-2 left-12 text-xs text-gray-500">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-xl font-semibold text-gray-900 mb-6">Monthly Breakdown</h3>
            ...
            <table className="w-full text-left">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-4 py-3 text-sm font-medium text-gray-700">Realized P&L</th>
                  <th className="px-4 py-3 text-sm font-medium text-gray-700">End NAV</th>
                  <th className="px-4 py-3 text-sm font-medium text-gray-700">Trading Days</th>
                </tr>
              </thead>
